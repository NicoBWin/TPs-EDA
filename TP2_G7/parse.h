 ...
 */
int parseCmdLine(int argc, char* argv[], pCallback p, void* userData);			//Recibe el ingreso de terminal y analiza si es una opcion o un parametro y los envía a la callback p
